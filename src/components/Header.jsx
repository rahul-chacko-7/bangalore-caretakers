        ...
        {mobileMenuOpen && (
          <div className="xl:hidden border-t border-slate-200/90 bg-white/98 backdrop-blur-xl px-4 pt-3 pb-8 space-y-4 shadow-2xl max-h-[85vh] overflow-y-auto animate-fadeIn divide-y divide-slate-100">
              ...
              <div className="grid grid-cols-1 gap-1">
                ...
                >
                  <span className="flex items-center gap-2">
                    <span>Senior Care Guides & Blog</span>
                  </span>
                  <span className="text-[10px] font-extrabold text-teal-600 bg-teal-50 px-2 py-0.5 rounded-md border border-teal-200">
                    Articles
                  </span>
                </Link>
                ...
                <Link
                  ...
                  onClick={() => setMobileMenuOpen(false)}
                  className={`flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-bold transition-all ${
                    location.pathname === '/caretaker-nursing-jobs-bangalore'
                      ? 'bg-teal-600 text-white shadow-md'
                      : 'text-slate-800 hover:bg-slate-100'
                  }`}
                >
                  <span>Caretaker & Nursing Jobs</span>
            ...
            <div className="pt-4 space-y-2.5">
              ...
              {/* WhatsApp & Google Reviews Quick Action Row */}
              <div className="grid grid-cols-2 gap-2">
                <a
                  href={`https://wa.me/${GENERAL_INFO.whatsappNumber}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-1.5 bg-emerald-50 border border-emerald-200 text-emerald-800 py-2.5 px-3 rounded-xl font-bold text-xs hover:bg-emerald-100 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-1 bg-amber-50 border border-amber-200 text-amber-900 py-2.5 px-3 rounded-xl font-bold text-xs hover:bg-amber-100 transition-colors"
                >
              ...
              <button
                ...
                className="w-full bg-teal-700 hover:bg-teal-800 text-white py-3 rounded-xl font-extrabold text-sm shadow-md flex items-center justify-center gap-2 transition-all active:scale-[0.99]"
              >
                <HeartHandshake className="w-4.5 h-4.5 text-teal-200" />
                <span>Book 24/7 Care / Schedule Visit</span>
              </button>

              {/* Direct Emergency Phone Call CTA Button */}
              <a
                href={`tel:${GENERAL_INFO.phoneRaw}`}
                className="w-full bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-950 py-3 rounded-xl font-black text-sm shadow-md flex items-center justify-center gap-2 border border-amber-300 transition-all active:scale-[0.99]"
              >
